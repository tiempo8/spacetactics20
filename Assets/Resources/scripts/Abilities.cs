...
public enum MissleSide : int
{
	FRIENDLY=0,
	ENEMY=1
}

public enum MissleType : int
{
	ROCKET=0,
	THORPEDE=1,
	GAS=2,
...
public static class Abilities
{
	...
	public static bool haveAbil(ArrayList abils, AbilityType type)
	{
		foreach(AbilityType ab in abils)
			if(ab==type) return true;
		return false;
	}
	...
	public static class MinesParameters
	{
		...
		public const int lifeTimeRounds=10;
	}
}